...
if __name__ == "__main__":
	...
	parser.add_argument('--llm', type=str, default="code-davinci-002", choices=["code-davinci-002", "chatgpt", "gpt-3.5-turbo", "gpt2", "qwen2.5-0.5b-instruct"], help='OpenAI model name')
