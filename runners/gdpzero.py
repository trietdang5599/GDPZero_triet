...
def main(cmd_args):
	...
	if cmd_args.llm in ['code-davinci-002']:
		...
		UsrModel = PersuadeeChatModel
		SysPlanner = P4GChatSystemPlanner
	elif cmd_args.llm in ['qwen2.5-7b', 'llamda-3-8b', 'deepseek-r1']:
		if cmd_args.llm == 'qwen2.5-7b':
			model_source = 'Qwen/Qwen2.5-7B-Instruct'
		elif cmd_args.llm == 'llamda-3-8b':
			model_source = 'meta-llama/Meta-Llama-Guard-2-8B'
...
if __name__ == "__main__":
	...
	parser.add_argument('--llm', type=str, default="code-davinci-002", choices=["code-davinci-002", "chatgpt", "gpt-3.5-turbo", "gpt2", "qwen2.5-7b", "llamda-3-8b", "deepseek-r1", "local"], help='Backbone model identifier')
