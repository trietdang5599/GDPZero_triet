...
def main(args):
	...
	elif args.judge in ['gpt2', 'qwen2.5-7b']:
		backbone_model = LocalModel(args.judge)
...
if __name__ == "__main__":
	...
	parser.add_argument('--judge', type=str, default='gpt-3.5-turbo', help='which judge to use.', choices=['gpt-3.5-turbo', 'gpt-5-nano', 'gpt-4o-mini', 'chatgpt', 'gpt2', 'qwen2.5-7b'])
